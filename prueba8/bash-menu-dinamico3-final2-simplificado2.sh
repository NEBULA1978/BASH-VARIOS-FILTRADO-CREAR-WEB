...
opciones=(
    ...
    "Salir:|exit 0"
    "Ver líneas del archivo elegido en la carpeta actual:|ls; read -p 'Introduzca el nombre del archivo: ' file_to_display; if [ -f \"\$file_to_display\" ]; then nl \"\$file_to_display\"; else echo \"El archivo \$file_to_display no existe.\"; fi"
