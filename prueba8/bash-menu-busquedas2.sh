...
while true; do
    ...
    case $opcion in
        ...
        3)
            ...
            ;;
        4)
            read -rp "Introduzca las letras para buscar archivos que empiecen con 'f' y terminen con '.txt': " letras
            ls "f*$letras.txt"
            read -rp "Presione Enter para continuar..."
            ;;
        5)
            read -rp "Introduzca las letras para buscar archivos que empiecen con 'f': " letras
            ls "f*$letras"
            read -rp "Presione Enter para continuar..."
            ;;
        6)
            read -rp "Introduzca dos letras para buscar archivos que empiecen con 'f' seguido de dos caracteres y terminen con '.txt': " letras
            ls "f??$letras.txt"
            read -rp "Presione Enter para continuar..."
            ;;
        7)
            read -rp "Introduzca tres letras para buscar archivos que empiecen con tres caracteres y terminen con '.txt': " letras
            ls "f???$letras.txt"
            read -rp "Presione Enter para continuar..."
            ;;
        8)
            read -rp "Introduzca dos letras para buscar archivos que empiecen con tres caracteres y terminen con '.tx?': " letras
            ls "f??$letras.tx?"
            read -rp "Presione Enter para continuar..."
            ;;
        9)
            read -rp "Introduzca un carácter para buscar archivos que terminen con un carácter después de 'fichero': " caracter
            ls "fichero?$caracter"
            read -rp "Presione Enter para continuar..."
            ;;
        10)
            read -rp "Introduzca un caracter para buscar archivos que empiecen con 'fichero' seguido por cualquier caracter: " caracter
            ls "fichero$caracter*"
            read -rp "Presione Enter para continuar..."
            ;;
        11)
