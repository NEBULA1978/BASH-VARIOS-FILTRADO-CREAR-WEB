...
# Display the content of the selected file with line numbers
nl -b a -n ln -w 4 -s '  ' "$archivo"
...
# Guardar las líneas seleccionadas in un archivo resultado con el contador
